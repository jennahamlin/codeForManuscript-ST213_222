...
## convert to tsibble to use with feasts and fable packages. The depdendent 
...
## is the same as above but without the mean line 
iso222 |>
  autoplot(caseCount)
...
## using fable TSLM; REQUIRES fpp package! We use year here instead of trend
...
# Coefficients:
#   Estimate Std. Error t value Pr(>|t|)    
# (Intercept) -348.0787    37.6115  -9.255 7.98e-08 ***
...
## caseCounts column: N(3.2, 0.54) forecast distribution is transformed (t)
## Normal (N) with mean (3.2) and variance (0.54). 

# # A tsibble: 10 x 6 [1Y]
# # Key:       .model [1]
# .model       year       caseCount .mean                    `80%`                   `95%`
# <chr>       <dbl>          <dist> <dbl>                   <hilo>                  <hilo>
# 1 time_series  2021 t(N(3.2, 0.54))  31.5 [ 9.647051,  63.64520]80 [ 5.854909, 104.8673]95
# 2 time_series  2022 t(N(3.4, 0.55))  36.5 [11.083133,  74.04198]80 [ 6.704202, 122.4034]95
# 3 time_series  2023 t(N(3.5, 0.56))  42.3 [12.728420,  86.16808]80 [ 7.672473, 142.9504]95
# 4 time_series  2024 t(N(3.6, 0.56))  49.1 [14.612807, 100.31539]80 [ 8.775867, 167.0364]95
# 5 time_series  2025 t(N(3.8, 0.57))  57.0 [16.770395, 116.82566]80 [10.032658, 195.2835]95
# 6 time_series  2026 t(N(3.9, 0.58))  66.1 [19.240077, 136.09904]80 [11.463533, 228.4249]95
# 7 time_series  2027 t(N(4.1, 0.59))  76.7 [22.066201, 158.60417]80 [13.091900, 267.3249]95
# 8 time_series  2028  t(N(4.2, 0.6))  89.0 [25.299331, 184.89001]80 [14.944240, 313.0031]95
# 9 time_series  2029 t(N(4.4, 0.61)) 103.  [28.997107, 215.59969]80 [17.050504, 366.6617]95
# 10 time_series  2030 t(N(4.5, 0.62)) 120.  [33.225226, 251.48680]80 [19.444563, 429.7194]95
...
#   1 arima  Training  8.22  4.42  81.0 0.895 0.851
# 2 ets    Training  7.13  3.74  71.4 0.757 0.738
# 3 lm     Training  7.13  3.74  71.4 0.757 0.738
